...
X_2d = svd.fit_transform(X_vect)

# ----------------------------
# Split train/test
# ----------------------------
X_train, X_test, y_train, y_test, X_train_2d, X_test_2d = train_test_split(
    X_vect, y, X_2d, test_size=0.3, random_state=42
)

# ----------------------------
# Train normal SVM on full TF-IDF
# ----------------------------
...
# ----------------------------
# Encode labels to numbers (Fix for contourf)
# ----------------------------
le = LabelEncoder()
y_train_num = le.fit_transform(y_train)   # ham=0, spam=1
...
# ----------------------------
# Create contourf decision boundary
# ----------------------------
...
# FIX LEGEND
labels = le.inverse_transform([0, 1])  # ['ham', 'spam']
